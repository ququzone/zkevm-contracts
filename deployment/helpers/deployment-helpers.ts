...
export async function deployPolygonZkEVMDeployer(
    ...
    const deployTxZKEVMDeployer = await ethers.deployContract("PolygonZkEVMDeployer", [deployerAddress], signer);
